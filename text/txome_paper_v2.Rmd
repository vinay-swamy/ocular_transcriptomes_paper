...
load('/data/swamyvs/ocular_transcriptomes_paper/clean_data/rdata/transcriptome_pipeline_stats.Rdata')
...
::: {custom-style="CustomCaption"}
Figure 6. DNTX000dddd, potentially protein coding novel isoform in Fetal RPE A RNA-seq coverage across 49 samples. B transcript model of DNTX000ddd. thick regions represtn coding region. C. Multiple sequence alignment of DNTX000ddd and closely related proteins.
:::
...
## A easy-to-use pipeline to enable future
...
"Because we observed that many of these transcripts were detected in one or two samples (sup fig 2) we refined our set of transcriptomes using series of filtering steps (methods) to remove low confidence transcripts."  - This is still somthing worth checking
