...
```{r, echo = F, include=T}
knitr::include_graphics('/data/swamyvs/ocular_transcriptomes_paper/clean_data/plots/LRP2_PCR.png')
```

::: {custom-style="CustomCaption"}
Supplemental Figure 4. PCR gel of LRP2 novel exon 43 and cannoical exon 2:3 
:::
