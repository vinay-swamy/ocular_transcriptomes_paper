...
ggplot(data = novel_transcripts_per_tissue) +
    ...
    ggtitle('Novel Transcripts built in occular tissues')+
...
upset(fromList(novel_exon_location_analysis))
...
ggplot(data = ss) +
    ...
    scale_fill_manual(values = color_list) +
    ggtitle('percent minimally used of novel Exons Detected in rMATs') +
     theme(axis.text.x=element_text(angle=45, hjust = 1))
```
